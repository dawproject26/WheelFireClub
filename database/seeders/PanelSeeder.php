...
class PanelSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $phrases = [
            ...
            ['movie' => 'LOS SIMPSONS', 'phrase' => 'QUIERO MI BOCADILLO'],
            ...
            ['movie' => 'STRANGER THINGS', 'phrase' => 'LOS AMIGOS NO MIENTEN'],
            ...
            ['movie' => 'EL SEÑOR DE LOS ANILLOS', 'phrase' => 'UN ANILLO PARA GOBERNARLOS A TODOS'],
        ];
